...
<?php $component->withAttributes(['field' => $field]); ?>
    <div class="inline-flex space-x-2">
        <img wire:model="image" class="rounded border-solid border-2" src="<?php echo e($field->image); ?>"/>
        <?php echo e($getAction('refreshImage')); ?>
...
<?php endif; ?>
<?php /**PATH D:\ARSICOM\PROYEK CMS\liwumokesanews\vendor\marcogermani87\filament-captcha\resources\views/forms/components/captcha-field.blade.php ENDPATH**/ ?>